...
export default function DashboardItem({ dashboard }: DashboardItemProps) {
    ...
    return (
        <div className="flex flex-col rounded-md border-[0.5px] bg-bolderCard w-72 gap-4 justify-between min-h-[600px] max-h-[600px] overflow-auto">
            <div className="flex flex-col gap-6 p-4">
                <div className="text-xl font-bold flex justify-between">
                    <h2 className="overflow-hidden overflow-ellipsis">{name}</h2>
